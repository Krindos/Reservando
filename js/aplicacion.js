...
Aplicacion.prototype.dibujarCiudades = function() {
    ...
    this.listado.filtrarPorCiudad().forEach(function(ciudad) {
...
Aplicacion.prototype.dibujarRubros = function() {
    ...
    this.listado.filtrarPorRubro().forEach(function(rubro) {
...
Aplicacion.prototype.dibujarHorarios = function() {
    ...
    this.listado.filtrarPorHorario().forEach(function(horario) {
